    ...
    def __call__(self, *args):
        ...
        if len(args) == 3:
            ...
            item = {
                'img_z': img_z,
                'img_x': img_x,
                'img_meta_z': {'ori_shape': img_z.shape, 'ori_gt_bboxes_z': target['bboxes_z']},    # added by gongyou.zyq
                'img_meta_x': {'ori_shape': img_x.shape, 'ori_gt_bboxes_x': target['bboxes_x']},    # added by gongyou.zyq
